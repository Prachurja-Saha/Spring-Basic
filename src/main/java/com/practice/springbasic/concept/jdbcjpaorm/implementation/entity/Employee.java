...
public class Employee {
    ...
    * */
    ...
    /*
            ...
            @JoinColumn(name = "laptop_id", referencedColumnName = "id") //-> referencedColumnName is Laptop primary key column
            private Laptop laptop;
       if you do not specify @JoinColumn, JPA will automatically create a foreign key column
    */
    ...
    /*
        One to Many -> uni
            ...
            @JoinColumn(name = "project_id") // Creates FK in Project table
            private List<Project> projects;
    */
